...
#### `use-cases/all.md` [(source)](https://github.com/slim-org/slim/blob/main/continuous-testing/use-cases/all.md)
...
#### `reference-architectures/ref-archi-XYZ.md` [(source)](https://github.com/slim-org/slim/blob/main/continuous-testing/reference-architectures/ref-archi-XYZ.md)
...
#### `trade-studies/trade-study-XYZ.md` [(source)](https://github.com/slim-org/slim/blob/main/continuous-testing/trade-studies/trade-study-XYZ.md)
...
#### `starter-kits/starter-kit-XYZ/` [(source)](https://github.com/slim-org/slim/blob/main/continuous-testing/starter-kits/starter-kit-XYZ.md)
