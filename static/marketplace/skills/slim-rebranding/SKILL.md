...
- 📋 **Guided Workflow**: Includes plan templates for review before execution
...
**None** - This skill works standalone with SLIM-based Docusaurus websites. No marketplace dependencies required.
...
2. **Docusaurus Website Detection**:
   ...
   - If not found, error: "This skill requires a Docusaurus website. Consider using the general slim-rebranding workflow instead."
