...
3. Perform a scan of the local repository for CVES (vulnerabilities)
    ...
    NOTE: you can use the `--only-severity critical` to limit scanning to just specific criticality levels. See documentation [here](https://docs.docker.com/reference/cli/docker/scout/cves/#options). 
