...
<img id="slim-leaderboard-gif" src="/slim/img/slim-leaderboard-demo.gif" alt="SLIM Leaderboard Demo - Scanning Repository" width="100%" />
...
<img id="slim-cli-gif" src="/slim/img/slim-cli-demo-apply.gif" alt="SLIM CLI Demo - Apply Command" width="100%" />
